...
public enum MessageId
{
	...
	LIST_ITEM,
	LIST_ITEM_INVALID,
	LIST_EMPTY, COMMAND_STATUS_HEADER, COMMAND_STATUS_PLUGIN_VERSION, COMMAND_STATUS_LANGUAGE, COMMAND_STATUS_LOCALE, COMMAND_STATUS_TIMEZONE, COMMAND_STATUS_DEFAULT_MATERIAL, COMMAND_STATUS_MINIMUM_DISTANCE, COMMAND_STATUS_TELEPORT_WARMUP, COMMAND_STATUS_TELEPORT_COOLDOWN, COMMAND_STATUS_SHIFT_CLICK, COMMAND_STATUS_CANCEL_ON_DAMAGE, COMMAND_STATUS_CANCEL_ON_MOVEMENT, COMMAND_STATUS_CANCEL_ON_INTERACTION, COMMAND_STATUS_INVENTORY_REMOVAL, COMMAND_STATUS_ALLOW_IN_RECIPES, COMMAND_STATUS_DISPLAY_LIGHTNING, COMMAND_STATUS_ENABLED_WORLDS, COMMAND_STATUS_FOOTER, COMMAND_STATUS_FROM_NETHER, COMMAND_STATUS_FROM_END,
}
