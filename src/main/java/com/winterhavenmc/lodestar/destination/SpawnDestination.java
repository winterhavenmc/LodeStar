...
public final class SpawnDestination extends AbstractDestination
{
	/**
	 ...
	 */
	SpawnDestination(final String displayName,
	 ...
	 */
	SpawnDestination(@Nonnull final String displayName, @Nonnull final Location location)
	{
